...
$options = array (
  ...
  array( "name" => "新浪微博","type" => "tit"),
	...
	array( "id" => "d_post_bottom","type" => "textarea","std"=>'<p>本站所有文章均采用 <a href="http://creativecommons.org/licenses/by-sa/4.0/deed.zh" target="_blank" rel="nofollow">CC BY-SA 4.0</a> 进行许可, 转载请保留链接并遵守许可协议.</p>'),
